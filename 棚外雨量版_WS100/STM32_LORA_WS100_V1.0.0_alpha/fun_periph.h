...
#define GREEN_PIN           PA7
#define RED_PIN             PA6

#define K1                  PB0 //Button1
#define K2                  PA5 //Button2

#define USBEN_PIN           PB3

#define I2C_PWR_PIN			PA8
...
#define I2C_PWR_ON					(digitalWrite(I2C_PWR_PIN, HIGH))
#define I2C_PWR_OFF					(digitalWrite(I2C_PWR_PIN, LOW))
