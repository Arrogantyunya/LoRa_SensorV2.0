...
Frame_ID Command_Analysis::FrameID_Analysis(void)
{
  ...
  unsigned char id;
  switch (frame_id){
    case 0xA011 : id = Work_Para;       break;
    case 0xA012 : id = Set_Group_Num;   break;
    case 0xA013 : id = SN_Area_Channel; break;
    case 0xA014 : id = Work_Status;     break;
    case 0xA022 : id = Work_Limit;      break;
  }
