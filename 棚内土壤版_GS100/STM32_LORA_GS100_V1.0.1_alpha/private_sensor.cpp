...
/*
 *brief   : According to the ID address and register(ModBus) address of the soil sensor, read temperature and humility
...
void Sensor::Read_Soild_PH(unsigned int * Solid_PH, unsigned char addr)
{
	...
	//	{
	//		Serial.println(String("Receive_Data[ ") + i + " ]=" + String(Receive_Data[i],HEX));
	//	}
	//	delay(5000);
	//}
